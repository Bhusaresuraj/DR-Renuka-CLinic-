                ...
                <div class="col-lg-8 order-lg-2">
                    <div class="services__details">
                        ...
                        <div class="services__details__text">
                            <p>We are committed to delivering advanced skin, hair, and wellness treatments with trusted expertise, personalized care, and proven results that help you look and feel your best</p>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
                        ...
                        <div class="services__details__desc">
                            <p>Cosmetology
We provide advanced skin treatments that help improve the health and beauty of your face and body.

Dermatology
Our dermatology care includes safe and effective treatments for skin infections and other conditions, with reliable results.

Skin Care
Complete solutions for healthy, glowing skin using modern and proven techniques.

Trichology
Specialized hair treatments to reduce hair fall, improve scalp health, and restore natural growth.
                            </p>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="services__sidebar">
                        <div class="services__accordion">
                            <div class="services__title">
                                <h4><img src="img/icons/services-icon.png" alt=""> All Treatments</h4>
                            </div>
                            <div class="accordion" id="accordionExample">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul>
                                                <li><a href="#">Impetigo</a></li>
                                                <li><a href="#">Molluscum</a></li>
                                                <li><a href="#">Telangiastacia</a></li>
                                                <li><a href="#">Hair & Scalp Disorder</a></li>
                                                <li><a href="#">Icthyosis</a></li>
                                                <li><a href="#">Scabies</a></li>
                                                <li><a href="#">Phymosis</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
<li>Stem Cell Treatment</li>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseThree" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul>
                                                <li><a href="#">Hair Prp</a></li>
                                                <li><a href="#">Hair GFC</a></li>
                                                <li><a href="#">Hair Tranlsplant</a></li>
                                                <li><a href="#">Hair Mesotherapy</a></li>
                                                <li><a href="#">Alopecia Treatment</a></li>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseFour" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul>
                                                <li><a href="#">Advance Hydra</a></li>
                                                <li><a href="#">Advance Pro Hydra</a></li>
                                                <li><a href="#">Laser Toning Treatment</a></li>
                                                <li><a href="#">Chemical Peeling</a></li>
                                                <li><a href="#">SKin Polishsing</a></li>
                                                <li><a href="#">Body Peel</a></li>
                                                <li><a href="#">Carbon Laser</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="services__appoinment">
                        <div class="services__title">
                            <h4><img src="img/icons/services-icon.png" alt=""> </h4>
                        </div>
                        <form action="#">
